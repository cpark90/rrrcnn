...
from continuous.custom.data import build_detection_train_loader
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        return RotatedCOCOEvaluator(dataset_name, cfg, True, output_dir=output_folder)
...
if __name__ == "__main__":
    ...
    # args.config_file = 'configs/detection/proposal_R_50_FPN.yaml'
    # args.config_file = 'configs/detection/branch_proposal_R_50_FPN.yaml'
