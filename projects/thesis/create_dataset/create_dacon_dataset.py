...
if __name__ == '__main__':
    ...
    # args.src_dir = '/ws/data/open_datasets/detection/dacon/dacon_org/train'
    # args.dst_path = '/ws/data/open_datasets/detection/dacon/dacon_patch_512_256/train'
    # args.is_include_only_pos = True
    # create_train_dataset(**vars(args))

    args.src_dir = '/ws/data/open_datasets/detection/dacon/dacon_org/test'
    args.dst_path = '/ws/data/open_datasets/detection/dacon/dacon_patch_512_256/test'
    args.is_include_only_pos = True
