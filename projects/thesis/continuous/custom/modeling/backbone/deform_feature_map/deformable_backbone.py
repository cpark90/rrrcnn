...
from detectron2.modeling import make_stage, ResNet
...
__all__ = ["build_deformnet_backbone_pretrain"]


@BACKBONE_PRETRAIN_REGISTRY.register()
def build_deformnet_backbone_pretrain(cfg, input_channels, num_classes):
    """
