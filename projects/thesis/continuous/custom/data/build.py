...
from .common import ClassificationMapDataset
from .mapper import build_dataset_mapper
...
def build_detection_test_loader(cfg, dataset_name, mapper=None):
    ...
    if mapper is None:
        mapper = build_dataset_mapper(cfg, False)
    dataset = MapDataset(dataset, mapper)
...
def get_classification_datasets(dataset_names):
    assert len(dataset_names)
    datasets = [DatasetCatalog.get(dataset_name) for dataset_name in dataset_names]
    return datasets
