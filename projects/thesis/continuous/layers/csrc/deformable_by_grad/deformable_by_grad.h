...
inline int deformable_by_grad_forward(
    at::Tensor input,
    at::Tensor offset,
    at::Tensor output,
    int gW,
  ...
  if (input.type().is_cuda()) {
    ...
    return deformable_by_grad_forward_cuda(
        input,
        offset,
        output,
        gW,
...
inline int deformable_by_grad_backward_input(
    at::Tensor input,
    at::Tensor offset,
    at::Tensor gradOutput,
    at::Tensor gradInput,
  ...
  if (gradOutput.type().is_cuda()) {
    ...
    TORCH_CHECK(offset.type().is_cuda(), "offset tensor is not on GPU!");
    return deformable_by_grad_backward_input_cuda(
        input,
        offset,
        gradOutput,
        gradInput,
