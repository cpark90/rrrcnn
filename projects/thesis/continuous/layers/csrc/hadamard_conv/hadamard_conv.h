...
inline int hadamard_conv_forward(
    at::Tensor input,
    at::Tensor weight,
    at::Tensor output,
    at::Tensor columns,
  ...
  if (input.type().is_cuda()) {
    ...
    return hadamard_conv_forward_cuda(
        input,
        weight,
        output,
        columns,
...
inline int hadamard_conv_backward_input(
    at::Tensor input,
    at::Tensor gradOutput,
    at::Tensor gradInput,
    at::Tensor weight,
  ...
  if (gradOutput.type().is_cuda()) {
    ...
    TORCH_CHECK(weight.type().is_cuda(), "weight tensor is not on GPU!");
    return hadamard_conv_backward_input_cuda(
        input,
        gradOutput,
        gradInput,
        weight,
...
inline int hadamard_conv_backward_filter(
    at::Tensor input,
    at::Tensor gradOutput,
    at::Tensor gradWeight, // at::Tensor gradBias,
    at::Tensor columns,
...
#ifdef WITH_CUDA
    TORCH_CHECK(input.type().is_cuda(), "input tensor is not on GPU!");
    return hadamard_conv_backward_parameters_cuda(
        input,
        gradOutput,
        gradWeight,
        columns,
